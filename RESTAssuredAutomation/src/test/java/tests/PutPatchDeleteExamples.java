...
public class PutPatchDeleteExamples {
	...
	public void testPatch() {
		...
		JSONObject request = new JSONObject();
		request.put("Sports", "Cricket");
		request.put("GOAT", "Kohli");
		System.out.println(request.toJSONString());

		// Submitting a PATCH request to the "/api/users/2" endpoint with a JSON
		// payload,
		// verifying a 200 OK status code, and logging the response—used to test
	...
	public void testDelete() {
		// Submitting a DELETE request to the "/api/users/2" endpoint without a request
		// body,
