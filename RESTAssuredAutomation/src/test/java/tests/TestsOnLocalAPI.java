...
public class TestsOnLocalAPI {
	...
	// STEP 1️: GET all users from local server to check the initial state of the
	// database.
	...
	// STEP 3️: PUT request to completely update the user added in the previous
	// POST.
	...
	// This will only update the `firstName` field to "Salman", leaving others
	// unchanged.
